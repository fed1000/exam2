...
if($arParams["IBLOCK_ID"] > 0 && $arParams["IBLOCK_PROP"] > 0 && $this->StartResultCache(false, ($arParams["CACHE_GROUPS"]==="N"? false: $USER->GetGroups())))
{
	...
	{
		$arResult["PICTURE"] = CFile::ResizeImageGet($arResult['DETAIL_PICTURE'], array('width'=>$arParams["IMG_WIDTH"], 'height'=>$arParams["IMG_WIDTH"]), BX_RESIZE_IMAGE_PROPORTIONAL, true); 
